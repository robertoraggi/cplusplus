...
## [1.1.28](https://github.com/robertoraggi/cplusplus/compare/v1.1.27...v1.1.28) (2023-11-04)


### Bug Fixes

* Add -fstatic-assert to enable static_assert ([6cfa502](https://github.com/robertoraggi/cplusplus/commit/6cfa502e4cfc9e5e821a1e4b9dbdab078d05b449))
* Add AST node to represent alignas type specifiers ([d7cd227](https://github.com/robertoraggi/cplusplus/commit/d7cd227be25919d8e8aa8931fd8f73cdec93d741))
* Add definition of wint_t to stddef.h ([2224a48](https://github.com/robertoraggi/cplusplus/commit/2224a48a9df08c2bdc025c284cf7fbd74c5bac29))
...
* Add option to dump the symbols to stdout ([0805e03](https://github.com/robertoraggi/cplusplus/commit/0805e032382c31b6e23d09346327a3c75fb11ca6))
...
* Add type to represent the unresolved types ([845be71](https://github.com/robertoraggi/cplusplus/commit/845be7123df05f6cd7a07e08ea42fd61c6c22e8a))
* Add type to represent unresolved bounded array types ([44fb0b0](https://github.com/robertoraggi/cplusplus/commit/44fb0b05fd8c1686612c7af9d7b2e47d56274300))
* Apply the decl specifiers to the symbols ([f5cf1cd](https://github.com/robertoraggi/cplusplus/commit/f5cf1cd5ff62c2f7f89fbf48a15a1719df3c5d18))
* Bind the template parameters ([b8114fa](https://github.com/robertoraggi/cplusplus/commit/b8114fae8487641d479e3769a1feda7b8ecdf7fa))
* Clean up parsing of elaborated type specifiers ([765ee56](https://github.com/robertoraggi/cplusplus/commit/765ee566aa51dd72a62e46c47b56a569beb3bb20))
...
* Evaluation of char literals ([fdfa8aa](https://github.com/robertoraggi/cplusplus/commit/fdfa8aaa0443e5bb85910820c4fc040bddc718db))
* Implemented __is_array type trait ([cff7a43](https://github.com/robertoraggi/cplusplus/commit/cff7a4310eca60f6770dcf384874c6fe36ff297e))
* Implemented __is_const and __is_volatile traits ([7f94af4](https://github.com/robertoraggi/cplusplus/commit/7f94af4869fa8ddce07675d08ee40c6e38ca40fd))
* Implemented __is_integral type trait ([d1c463d](https://github.com/robertoraggi/cplusplus/commit/d1c463dba3479b4c146ca4c71b3f0bfa238fa60a))
* Implemented __is_lvalue_reference and __is_rvalue_reference type traits ([845f336](https://github.com/robertoraggi/cplusplus/commit/845f336c6fb5d7b801e7ce9c82dffbb367ff9932))
* Implemented __is_null_pointer trait ([d78fc36](https://github.com/robertoraggi/cplusplus/commit/d78fc36e34c0b4f8791eb9d1a4eae9f7253ad67c))
* Implemented __is_pointer trait ([d9f8488](https://github.com/robertoraggi/cplusplus/commit/d9f8488f189975a88c5405eee1dd67046dc6a64c))
* Implemented __is_same trait ([c7c90f0](https://github.com/robertoraggi/cplusplus/commit/c7c90f03f42294680753e8eb975ec93cbee49ce7))
* Implemented __is_signed and __is_unsigned type traits ([8024628](https://github.com/robertoraggi/cplusplus/commit/80246281bedaed8afac0500e5cb74fa264d96a07))
* Implemented is_floating_point type trait ([5f54f6b](https://github.com/robertoraggi/cplusplus/commit/5f54f6b859270bcd8722090443a02f6c9c5fd871))
* Implemented is_function, is_class and is_union ([35763eb](https://github.com/robertoraggi/cplusplus/commit/35763eb85dccbfe52ecd7b97e3104bfadfa4fbf1))
* Implemented the __is_void type trait expression ([2659515](https://github.com/robertoraggi/cplusplus/commit/2659515af90cf9f8a2cb18fc40342d0ce8bf9dad))
* Improve evaluation 0f floating point literals ([8a70e70](https://github.com/robertoraggi/cplusplus/commit/8a70e70c6af10519702ea0c5447dc229c4dcc365))
* Improve evaluation of integer literals ([4ac9daf](https://github.com/robertoraggi/cplusplus/commit/4ac9dafa1849319e4ea23ee89995696975bb627f))
* Initial work on the symbol binder ([87c936b](https://github.com/robertoraggi/cplusplus/commit/87c936bf47ecd72a75d408be32b6f08d4e90a92d))
* Parse of complex type specifiers ([d2fd111](https://github.com/robertoraggi/cplusplus/commit/d2fd111ccb704e8a981a84b3bad1f171d09d7cf5))
...
* Parse of the string literal escaped characters ([de37882](https://github.com/robertoraggi/cplusplus/commit/de37882635f268b7c4be5dff044dc9cc698da88e))
* Parse optional trailing attribute specifiers ([03f7887](https://github.com/robertoraggi/cplusplus/commit/03f788770fe35b322558001ea239685d94e81d4a))
* Parsing of attributes in function declarators ([d1324c7](https://github.com/robertoraggi/cplusplus/commit/d1324c7951d82ba987bb6812218b4be5f33eb3fa))
...
* Reduce the amount of backtracing when parsing simple declarations ([1c54417](https://github.com/robertoraggi/cplusplus/commit/1c544172857a5e1d9f321238d828f864364a005a))
...
* Rework the AST for declarator ids and bitfields ([2521fe2](https://github.com/robertoraggi/cplusplus/commit/2521fe2ca7c0fa1aedcc473ac91c296b15856cc1))
* Set the type of some of the literal expressions ([c2c0d11](https://github.com/robertoraggi/cplusplus/commit/c2c0d112b5d6f398d1a1715a7345b60d26538bde))
