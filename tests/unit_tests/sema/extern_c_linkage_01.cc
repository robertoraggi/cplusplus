...
// CHECK-NEXT:    constructor constexpr inline defaulted void Widget()
// CHECK-NEXT:    constructor constexpr inline defaulted void Widget(const ::Widget&)
// CHECK-NEXT:      parameters
// CHECK-NEXT:        parameter const ::Widget&
// CHECK-NEXT:    constructor constexpr inline defaulted void Widget(::Widget&&)
// CHECK-NEXT:      parameters
...
// CHECK-NEXT:      parameters
// CHECK-NEXT:        parameter const ::Widget&
// CHECK-NEXT:    function constexpr inline defaulted ::Widget& operator =(::Widget&&)
// CHECK-NEXT:      parameters
// CHECK-NEXT:        parameter ::Widget&&
